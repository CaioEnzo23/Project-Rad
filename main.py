...
from front import bar_valores,pie_valores, inserir_categoria, ver_categoria, inserir_receita, inserir_gastos,tabela ,deletar_gastos ,deletar_receitas
...
def percentagem():
    l_name = Label(frameMeio, text="Porcentagem da Receita gasta", height=1,anchor=NW, font=('Verdana 12'), bg=co1, fg=co4)
...
def resumo():
    ...
    l_sumario = Label(frameMeio, text="Total Renda Mensal      ".upper(), anchor=NW, font=('Verdana 12'), bg=co1, fg='#228b22')
    ...
    l_sumario = Label(frameMeio, text="Total Despesas Mensais   ".upper(), anchor=NW, font=('Verdana 12'), bg=co1, fg='#228b22')
    ...
    l_sumario = Label(frameMeio, text="Total Saldo da Caixa      ".upper(), anchor=NW, font=('Verdana 12'), bg=co1, fg='#228b22')
...
def grafico_pie():
    ...
    lista_categorias = pie_valores()[1]
...
# Botao Inserir
img_add_despesas = Image.open('button-add.png')
img_add_despesas = img_add_despesas.resize((17,17))
img_add_despesas = ImageTk.PhotoImage(img_add_despesas)

botao_inserir_despesas = Button(frame_operacoes,command=inserir_categoria_b, image=img_add_despesas, text=" Adicionar".upper(), width=80, compound=LEFT, anchor=NW, font=('Ivy 7 bold'), bg=co1, fg=co0, overrelief=RIDGE)
...
img_delete = Image.open('button-remove.png')
...
# Botao Inserir
img_add_receitas = Image.open('button-add.png')
img_add_receitas = img_add_receitas.resize((17,17))
img_add_receitas = ImageTk.PhotoImage(img_add_receitas)

botao_inserir_receitas = Button(frame_configuracao,command=inserir_categoria_b, image=img_add_receitas, text=" Adicionar".upper(), width=80, compound=LEFT, anchor=NW, font=('Ivy 7 bold'), bg=co1, fg=co0, overrelief=RIDGE)
...
# Botao Inserir
img_add_categoria = Image.open('button-add.png')
img_add_categoria = img_add_categoria.resize((17,17))
img_add_categoria = ImageTk.PhotoImage(img_add_categoria)

botao_inserir_despesas = Button(frame_configuracao,command=inserir_categoria_b, image=img_add_categoria, text=" Adicionar".upper(), width=80, compound=LEFT, anchor=NW, font=('Ivy 7 bold'), bg=co1, fg=co0, overrelief=RIDGE)
